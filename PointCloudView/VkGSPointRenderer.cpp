...
void VkGSPointRenderer::create(const Phantom::VKG::VulkanContext& ctx,
    ...
    gfxSetLayout_.create(dev, { uboBinding });
    ...
    gfxPipeline_.create(ctx, renderPass, pCfg);
    ...
    gfxPool_.create(dev, { uboPool }, framesInFlight_);
    ...
    computePipeline_.create(ctx, cCfg);
}
